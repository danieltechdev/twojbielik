...
import type {CodeTranslations, I18n} from '@docusaurus/types/src/i18n';
import type {LoadedPlugin, PluginVersionInformation} from '@docusaurus/types/src/plugin';
import type {PluginRouteConfig} from '@docusaurus/types/src/routing';
