...
import type {CodeTranslations, TranslationFile} from '@docusaurus/types/src/i18n';
...
import type {ThemeConfig} from '@docusaurus/types/src/config';
import type {LoadContext, Props} from '@docusaurus/types/src/context';
import type {SwizzleConfig} from '@docusaurus/types/src/swizzle';
