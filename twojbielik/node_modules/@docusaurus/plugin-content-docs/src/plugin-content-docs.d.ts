...
declare module '@docusaurus/plugin-content-docs' {
  ...
  export type PluginOptions = MetadataOptions &
    ...
    SidebarOptions & {
      ...
      sidebarItemsGenerator: import('@docusaurus/plugin-content-docs/src/sidebars/types.js').SidebarItemsGeneratorOption;
      /**
  ...
  export type Options = Partial<
    ...
    >
  >;
  export type SidebarsConfig = import('@docusaurus/plugin-content-docs/src/sidebars/types.js').SidebarsConfig;
  ...
  export type CategoryGeneratedIndexMetadata = Required<
    Omit<
      import('@docusaurus/plugin-content-docs/src/sidebars/types.js').SidebarItemCategoryLinkGeneratedIndex,
      'type'
    >,
    'title'
  > & {
  ...
  export type PropSidebarItemLink =
    import('@docusaurus/plugin-content-docs/src/sidebars/types.js').PropSidebarItemLink;
  export type PropSidebarItemHtml =
    import('@docusaurus/plugin-content-docs/src/sidebars/types.js').PropSidebarItemHtml;
  export type PropSidebarItemCategory =
    import('@docusaurus/plugin-content-docs/src/sidebars/types.js').PropSidebarItemCategory;
  export type PropSidebarItem = import('@docusaurus/plugin-content-docs/src/sidebars/types.js').PropSidebarItem;
  export type PropSidebarBreadcrumbsItem =
    import('@docusaurus/plugin-content-docs/src/sidebars/types.js').PropSidebarBreadcrumbsItem;
  export type PropSidebar = import('@docusaurus/plugin-content-docs/src/sidebars/types.js').PropSidebar;
  export type PropSidebars = import('@docusaurus/plugin-content-docs/src/sidebars/types.js').PropSidebars;
  ...
  export type LoadedVersion = VersionMetadata & {
    docs: DocMetadata[];
    drafts: DocMetadata[];
    sidebars: import('@docusaurus/plugin-content-docs/src/sidebars/types.js').Sidebars;
  };
